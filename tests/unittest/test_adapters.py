...
class TestPipelineAdapterProtocol:
    ...
    def test_custom_adapter_implements_protocol(self):
        ...
        adapter: PipelineAdapter = CustomAdapter()  # type: ignore
...
class TestDltAdapterInitialization:
    ...
    def test_lazy_loading_fails_gracefully_if_dlt_missing(self):
...
class TestDltAdapterPipelineCreation:
    ...
    def test_create_pipeline_requires_destination(self):
    ...
    def test_create_pipeline_with_minimal_config(self):
    ...
    def test_create_pipeline_with_full_config(self):
    ...
    def test_create_pipeline_handles_dlt_errors(self):
...
class TestDltAdapterPipelineExecution:
    ...
    def test_run_pipeline_executes_successfully(self):
    ...
    def test_run_pipeline_handles_execution_errors(self):
...
class TestDltAdapterTransformations:
    ...
    def test_apply_transformations_with_no_transformers(self):
    ...
    def test_apply_transformations_applies_single_transformer(self):
    ...
    def test_apply_transformations_chains_multiple_transformers(self):
    ...
    def test_apply_transformations_validates_callable(self):
    ...
    def test_apply_transformations_handles_transformer_errors(self):
    ...
    def test_apply_transformations_reports_correct_transformer_index(self):
...
class TestDltAdapterIncrementalLoading:
    ...
    def test_prepare_source_without_incremental_config(self):
    ...
    def test_prepare_source_with_incremental_config(self):
    ...
    def test_prepare_source_with_minimal_incremental_config(self):
    ...
    def test_prepare_source_handles_incremental_errors(self):
